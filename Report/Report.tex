...
\begin{center}
    ...
    \includegraphics[width=0.5\textwidth]{../results/Q2B_NN_examples}

  \caption{Examples of a successful classification and a failed classification: Successfully Classified Testing Face, Example from Assigned Class, Unsuccessfully Classified Testing Face, Example from Assigned Class,  \label{fig:Q2B_NN_examples}}

\end{center}
\end{figure}

Using this method, each testing vector was classified. In $70.1293\%$, the classification was successful and testing images were assigned to the correct class. This method is classification works only on how similar the testing image is to another similar image, so it is easily fooled by incorrect pictures with similar lighting, or testing images that have a particular difference from the training data, i.e. the removal of the glasses in the failure example in Figure \ref{fig:Q2B_NN_examples}.
