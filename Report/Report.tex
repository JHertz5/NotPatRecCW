...
-1&-1 \end{bmatrix} $ describe the same plane. The best 3 eigenfaces are shown in Figure \ref{fig:Eig4} . Note the direction reversal in the middle image.

\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{../results/Q1B_PCA_Eigenfaces}

  \caption{Top 3 Eignefaces \label{fig:Eig4}}
